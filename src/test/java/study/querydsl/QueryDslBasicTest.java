...
public class QueryDslBasicTest {
    ...
    /**
     * 연관 관계 없는 엔티티 외부 조인. 회원의 이름이 팀 이름과 같은 회원 조회
     */
    @Test
    ...
    public void tupleProjection() {
        ...
        // tuple은 repository에서만 사용하고 밖 계층으로 전달하는건 비추천한다.
        for (Tuple tuple : result) {
    ...
    public void bulkUpdate() {
        ...
        //update 같은 벌크 연산 후에는 영속성 컨텍스트와 db 데이터가 동기화되지 않기 때문에 엔티티 매니저를 flush, clear 해준다.
        em.flush();
        em.clear();
    }
